...
<strong>A note about tutorials:</strong> I think its OK to start with one or two tutorials if everything feels foreign to you, but you are going to learn better and be more invested if it can be adapted into a real project you find interestig or rewarding. Again, its about the motivation to learn new things. This is how I use tutorials today.
...
The HTML spec already has so much accessibility baked into it. As long as you are writing structured, semantic HTML and providing textual alternatives for non-text content, you're probably 90% there. The easiest things to mess up accessibility-wise in HTML are probably the <code>form</code>, <code>button</code>, and <code>input</code> tags. Read up on the ARIA roles, and keep the [Accessibility Project](http://a11yproject.com/checklist.html) open in your browser tabs for reference when working on your projects. 

In CSS, you can't specify alt text, so make sure you are only using the <code>background-image</code> property for decoration, not contextual images with meaning. Read up on colorblindness, and install an app or browser add-on that simulates different types of colorblindess and low-vison conditions so you are providing the best possible viewing experience in your design decisions.

If you are including interactive content, multimedia, animation or visualizations, try to use a library that supports multiple inputs: touchscreens, mouse, and keyboard. Don't use autoplayng audio, video, or slideshows without start and stop controls. If you have complex site navigation, consider adding 'skip to main content' or 'skip to navigation' links near the top of your HTML document

If you have a phone or tablet with accessibility features and a web browser, try turning these on and attempt to navigate the web by voice only, or with your eyes shut. If you want to go deeper, install the free NVDA-JAWS reader and learn how to navigate the web with it.

###Progressive Enhancement
Progressive enahancement is about delivering a user experience free of technological restrictions. There are a variety of devices, browsers and technologies all hitting the same website. The website does not need to look the same in each browser, but the rudimentary experience (connection is made, text content is displayed) is consistent. If the technology fails to render the javascript or CSS, can a user still interact with the content?

The other part of the enhancement is delivering fallbacks for new features not supported by older technology. Its not about making the website look the same in each browser, but making sure the content and information are readable and accessible, and the experience is consitent to what the user is accustomed to seeing. This concept is the key to fault tolerance and longevity on the web.

###Other Technical Skills
To be a good, useful generalist, it is important to have a deep understanding of the fundamentals, and then a surface level understanding of most things related to the role. For example, If I had a chance to meet Kristina Halvorson or Karen McGrane, I probably wouldn’t tell them I’m also a content strategist, but for a client who is only focused on their business and knows very little about how people interact with web content, I’m good enough, and know which questions to ask to provide the most helpful advice or get them started.

Once you know your HTML, CSS and Javascript, and can get these files to your server, what should you learn next? I would suggest Git or some command line stuff or a templating language. Git is a version control for software development (a little like track changes in Micrsoft Word), and helpful for working in teams, or on open-source projects.
...
I don’t think an everyday developer needs to become a database expert. Not every website needs a complex database structure or server-side technology. Static sites are becoming very popular for a good reason: they are quick to build and deploy, cheaper to host, and often more performant for the end user. Don’t get me wrong: databases certainly have their place on certain kinds of sites, but if you are just starting out or only interested in working on the front-end, this is not something you need to focus on today.
...
If I were job hunting, the best advice would be to use whatever is the job title advertised. But look out for red flags in position descriptions: <em>"5+ years of React.js experience"</em> is terrible, because React has only been out for two years. Confusing Java with Javascript is probably the result of a non-technical person attenpting to write a technical job description. I've found that the better jobs advertised aren't super prescriptive for every little technical thing. They know that new things are going to come along, and are probably more interested in <em>how</em> you work, than every tiny thing you are aware of.

###People Skills
Becoming an everyday developer means working with clients and other people. Good communication skills are a requirement. Practice your interviewing and presentation skills. When you are getting the project specs from a client, think like a researcher, not like a job interviewer or a journalist.  When you are [showing work for sign-off and approval](https://medium.com/@monteiro/13-ways-designers-screw-up-client-presentations-51aaee11e28c), think of it as a sales pesentation. You don't need to be Don Draper or Billy Mays. Focus on the goals and the pain points you are solving. The design doesn't need you to be its defender or realator.

Learn how to be a good listener. Learn how to be a [great co-worker](http://www.slideshare.net/JennLukas/a-guide-to-49840642). The technology industry is rotten with misogyny, racism, and entitlement; don't be one of those jerks. Empathize with your clients. Have more empathy for their customers. Ego management is a [core design skill](https://deardesignstudent.com/we-re-all-imposters-95d6aef8053f). Megan Hustad's <em>[How to Be Useful](https://www.goodreads.com/book/show/2993383-how-to-be-useful)</em> is a great read if you are more than a little skeptical/cynical about anything in the "business book" or "self-help" section of the bookstore. You aren't designing for things for screens, you are designing for humans.
...
* David Kadavy, [How to Learn Web Design](http://designforhackers.com/blog/how-to-learn-web-design/), 2015.
* Erik Runyon, [Lessons learned from my first semester of teaching](http://erikrunyon.com/2014/01/lessons-learned-from-my-first-semester-of-teaching/), 2014.
* Kylie Timpani, [Dear Developer. Love, Designer.](http://humaan.com/dear-developer-love-designer/), 2015.
* The Web Ahead, ep. 101: [Structuring Conent with Eileen Webb](http://thewebahead.net/101), 2015.